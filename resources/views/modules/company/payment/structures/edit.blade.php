                ...
                <div class="portlet light">
                    ...
                    <div class="portlet-body form">
                        <div class="form-body">
                            ...
                            <div class="form-group form-md-line-input form-md-floating-label">
                                <textarea type="text" class="form-control" id="description" name="description" required rows="5">{{ $structure->description or old('description') }}</textarea>
                            ...
                            <div class="form-group form-md-line-input form-md-floating-label">
                                ...
                                <div class="input-group">
                                    ...
                                    <select class="form-control" id="unit" name="unit">
                                        <option value="Hour" {{ "Hour" == $structure->unit ? 'selected' : '' }}>Hour</option>
                                        <option value="Month" {{ "Month" == $structure->unit ? 'selected' : '' }}>Month</option>
                                        <option value="Unit" {{ "Unit" == $structure->unit ? 'selected' : '' }}>Unit</option>
                                    </select>
                                </div>
