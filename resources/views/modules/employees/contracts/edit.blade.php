...
@section('content')
    ...
    <div class="row">
        <div class="col-sm-12">
            <form action="{{ route('contracts.update', $contract->id) }}" method="post" role="form">
                {{ csrf_field() }}
                {{ method_field('put') }}
                <div class="row">
                    <div class="col-sm-12">
                            ...
                            <div class="portlet-body form">
                                <div class="form-body">
                                    <div class="form-group form-md-line-input">
                                        <p class="form-control" id="employee">{{ $contract->employee->payroll_number }} - {{ $contract->employee->first_name }} {{ $contract->employee->last_name }}</p>
                                    ...
                                    <div class="form-group form-md-line-input">
                                        <select class="form-control" id="pay_grade_id" name="pay_grade_id">
                                            @foreach($pay_grades as $payGrade)
                                                <option value="{{ $payGrade->id }}" {{ $contract->pay_grade_id == $payGrade->id ? 'selected' : '' }}>{{ $payGrade->name }}</option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="form-group form-md-line-input">
                                        ...
                                        <input type="hidden" name="payment_structure_id" value="{{ $contract->payment_structure_id }}">
                                    ...
                                    <div class="form-group form-md-line-input form-md-floating-label">
                                        ...
                                        <div class="input-group date margin-bottom-5" readonly>
                                            ...
                                            <input type="text" id="current_basic_salary" name="current_basic_salary" class="form-control text-right" value="{{ $contract->current_basic_salary }}" required>
                                            <span class="input-group-btn">
                                    ...
                                    <div class="form-group form-md-line-input">
                                        <select class="form-control" id="employee_type_id" name="employee_type_id">
                                            @foreach($employee_type as $empType)
                                                <option value="{{ $empType->id }}" {{ $contract->employee_type_id == $empType->id ? 'selected' : '' }}>{{ $empType->name }}</option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="form-group form-md-line-input form-md-floating-label">
                                        ...
                                        <div class="input-group date date-picker margin-bottom-5" readonly data-date-format="dd-mm-yyyy">
                                            <input type="text" class="form-control form-filter input-sm" name="start_date" value="{{ $contract->start_date->format('d-m-Y') }}" required>
											<span class="input-group-btn">
                                    ...
                                    <div class="form-group form-md-line-input form-md-floating-label">
                                        ...
                                        <div class="input-group date date-picker margin-bottom-5" readonly data-date-format="dd-mm-yyyy">
                                            <input type="text" class="form-control form-filter input-sm" name="end_date"  value="{{ $contract->end_date->format('d-m-Y') }}" required>
											<span class="input-group-btn">
											    <button class="btn btn-sm default" type="button"><i class="fa fa-calendar"></i></button>
											</span>
                                        </div>
