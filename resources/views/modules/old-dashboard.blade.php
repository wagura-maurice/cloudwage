    ...
    <div class="row margin-top-10 dashboard">
        <a href="#" class="col-sm-3">
            <div class="dashboard-stat2">
                <div class="display">
                    <div class="number">
                        <h3 class="font-green-sharp">{{ \Payroll\Models\Department::all()->count() }}</h3>
        ...
        <a href="/payroll/create" class="col-sm-3">
            <div class="dashboard-stat2">
                <div class="number">
                    <h3 class="font-green-sharp">{{ number_format($wages, 2) }}</h3>
        ...
        <a href="/employees" class="col-sm-3">
            <div class="dashboard-stat2">
                <div class="number">
                    <h3 class="font-green-sharp">{{ number_format($employees, 0) }}</h3>
        ...
        <a href="/departments" class="col-sm-3">
            <div class="dashboard-stat2">
                <div class="number">
                    <h3 class="font-green-sharp">{{ number_format($departments, 0) }}</h3>
