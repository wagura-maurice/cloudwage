                ...
                <div class="portlet light">
                    ...
                    <div class="portlet-body form">
                        <div class="form-body">
                            ...
                            <div class="form-group form-md-line-input form-md-floating-label">
                                <input type="number" class="form-control" id="time_allowance" name="time_allowance" min="0" value="{{ old('time_allowance') or 60 }}" required>
                            ...
                            <div class="form-group form-md-line-input form-md-floating-label">
                                <input type="number" class="form-control" id="breaks" name="breaks" min="0" value="{{ old('breaks') or 60 }}" required>
                            ...
                            <div class="row">
                                <div class="form-group form-md-line-input form-md-floating-label col-sm-3">
                                    ...
                                    <input type="checkbox" class="make-switch" data-on-text="YES" data-off-text="NO" data-on="success" data-off="warning" id="is_overnight" name="is_overnight">
                                    <br/><br/>
