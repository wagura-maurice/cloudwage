                        ...
                        <div class="form-body row">
                            <div class="col-sm-6">
                                ...
                                <div class="form-group form-md-line-input form-md-floating-label">
                                    ...
                                    <div class="form-control">{{ $grade->paymentStructure->name }}</div>
                                </div>
                                <div class="form-group form-md-line-input form-md-floating-label">
                                    <label for="name">Salary Per {{ $grade->paymentStructure->unit }}</label>
                                    <div class="form-control">{{ $grade->currency->code .' ' . number_format($grade->basic_salary, 2) }}</div>
                                </div>
                                <div class="form-group form-md-line-input form-md-floating-label">
                                    <label for="advance_for_future">Advance For Future</label>
                                    <div>{{ $grade->advance_for_future == 0 ? 'No' : 'Yes' }}</div>
                                    <span class="help-block">This is advance given in the future</span>
                                </div>
                                <div class="form-group form-md-line-input form-md-floating-label">
                                    <label for="multiple_advances">Multiple Advances</label>
                                    <div>{{ $grade->multiple_advances == 0 ? 'No' : 'Yes'}}</div>
                                    <span class="help-block">These are multiple advances given</span>
                                </div>
                                <div class="form-group form-md-line-input form-md-floating-label">
                                    <label for="advance_basic">Advance Basic</label>
                                    <div>{{ $grade->advance_basic == 0 ? 'No' : 'Yes' }}</div>
                                </div>
                                <div class="form-group form-md-line-input form-md-floating-label">
                                    <label for="">Gross Percentage as Advance(%)</label>
                                    <div>{{ $grade->gross_percentage }}</div>
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group form-md-line-input form-md-floating-label">
                                ...
                                <div class="form-group form-md-line-input form-md-floating-label">
                                    ...
                                    <a class="btn btn-warning" href="{{ route('grades.index') }}">Back</a>
                                </div>
                            </div>
                        </div>
                    </div>
